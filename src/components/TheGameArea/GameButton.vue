  ...
  <div>
    ...
    >
      <svg style="display: none">
        ...
        <symbol id="restart" viewBox="0 0 88 88">
          <path d="M7.6,38.7h5c1.4,0,2.5,0.4,3.2,1.1c0.6,0.6,0.9,1.4,0.9,2.4v0c0,1.8-1.1,2.9-2.7,3.4l3,4.2h-2.3L12,45.9H9.6v3.9h-2V38.7zM12.4,44.2c1.4,0,2.3-0.7,2.3-1.9v0c0-1.2-0.9-1.8-2.3-1.8H9.6v3.7H12.4z"/>
          <path d="M19.1,38.7h8.3v1.8h-6.3v2.9h5.6v1.8h-5.6v3h6.4v1.8h-8.3V38.7z"/>
          <path d="M29,48.2l1.2-1.4c1.1,0.9,2.1,1.4,3.5,1.4c1.2,0,2-0.6,2-1.4v0c0-0.8-0.4-1.2-2.5-1.7c-2.4-0.6-3.7-1.3-3.7-3.3v0c0-1.9,1.6-3.2,3.8-3.2c1.6,0,2.9,0.5,4,1.4l-1.1,1.5c-1-0.7-2-1.1-3-1.1c-1.1,0-1.8,0.6-1.8,1.3v0c0,0.9,0.5,1.2,2.6,1.8c2.4,0.6,3.6,1.4,3.6,3.3v0c0,2.1-1.6,3.3-4,3.3C32,50,30.4,49.4,29,48.2z"/>
          <path d="M42.5,40.5h-3.5v-1.8h9v1.8h-3.5v9.3h-2V40.5z"/>
          <path d="M52.5,38.6h1.8l4.9,11.2h-2.1l-1.1-2.7h-5.3l-1.1,2.7h-2L52.5,38.6z M55.3,45.4l-1.9-4.5l-1.9,4.5H55.3z"/>
          <path d="M61.2,38.7h5c1.4,0,2.5,0.4,3.2,1.1c0.6,0.6,0.9,1.4,0.9,2.4v0c0,1.8-1.1,2.9-2.7,3.4l3,4.2h-2.3l-2.7-3.9h-2.5v3.9h-2V38.7zM66,44.2c1.4,0,2.3-0.7,2.3-1.9v0c0-1.2-0.9-1.8-2.3-1.8h-2.8v3.7H66z"/>
          <path d="M75.4,40.5h-3.5v-1.8h9v1.8h-3.5v9.3h-2V40.5z"/>
        </symbol>
      </svg>
      <svg>
    ...
    <audio v-if="$store.state.settings.isSoundEnabled" ref="sound" src="/click.mp3"></audio>
  </div>
</template>
